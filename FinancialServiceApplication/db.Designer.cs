...
namespace FinancialServiceApplication {
    ...
    public partial class db : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Name, decimal Rate, int VendorId) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public decimal Rate {
                get {
                    return ((decimal)(this[this.tableProducts.RateColumn]));
                }
                set {
...
namespace FinancialServiceApplication.dbTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([Nam" +
                "e] = @Original_Name) AND ([Rate] = @Original_Rate) AND ([VendorId] = @Original_V" +
                "endorId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Rate], [VendorId]) VALUES (@Name, @Rate, @" +
                "VendorId);\r\nSELECT ProductId, Name, Rate, VendorId FROM Products WHERE (ProductI" +
                "d = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Rate] = @Rate, [VendorId] = @VendorId WHERE (([ProductId] = @Original_ProductId) AND ([Name] = @Original_Name) AND ([Rate] = @Original_Rate) AND ([VendorId] = @Original_VendorId));
SELECT ProductId, Name, Rate, VendorId FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FinancialServiceApplication.Properties.Settings.Default._4619868F587328335CD4731366C17B86_SERVICEAPPLICATIONSOLUTION_MAIN_FINANCIALSERVICEAPPLICATION_BIN_DEBUG_FINANCIALCONSULTANTDB_MDFConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, Name, Rate, VendorId FROM dbo.Products";
        ...
        public virtual int Fill(db.ProductsDataTable dataTable) {
        ...
        public virtual db.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db.ProductsDataTable dataTable = new db.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductId, string Original_Name, decimal Original_Rate, int Original_VendorId) {
        ...
        public virtual int Insert(string Name, decimal Rate, int VendorId) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, decimal Rate, int VendorId, int Original_ProductId, string Original_Name, decimal Original_Rate, int Original_VendorId, int ProductId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Rate, int VendorId, int Original_ProductId, string Original_Name, decimal Original_Rate, int Original_VendorId) {
            return this.Update(Name, Rate, VendorId, Original_ProductId, Original_Name, Original_Rate, Original_VendorId, Original_ProductId);
        }
    }
